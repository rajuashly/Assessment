...
namespace Express.BusinessLayer
{
    public class Cryptography
    {
        ...
        {
            string EncryptionKey = "EncryptKeyExpress";  //we can change the code converstion key as per our requirement    
            ...
            0x49, 0x76, 0x61, 0x6e, 0x20, 0x4d, 0x65, 0x64, 0x76, 0x65, 0x64, 0x65, 0x76
                ...
                using (MemoryStream ms = new MemoryStream())
                {
                    ...
                    encryptString = Convert.ToBase64String(ms.ToArray()).Replace('+', '-').Replace('/', '_');
                }
            }
        ...
        {
            string EncryptionKey = "EncryptKeyExpress";  //we can change the code converstion key as per our requirement, but the decryption key should be same as encryption key    
